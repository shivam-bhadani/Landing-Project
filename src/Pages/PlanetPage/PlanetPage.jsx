    ...
    return (
        <div className="planetPagediv">
            <div className="planet-div">
                ...
                <div className="planet-img-div"><img src="images/planet4.png" alt="planet" className="planet-img" className="planet4" /></div>
                <div className="planet-img-div"><img src="images/planet5.png" alt="planet" className="planet-img" /></div>
                <div className="planet-img-div"><img src="images/planet6.png" alt="planet" className="planet-img" /></div>
            </div>
        </div>
    )
}
